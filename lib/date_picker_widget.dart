          ...
          return DateWidget(
            ...
            dayTextStyle: isDeactivated
                ...
                : isSelected
                    ? selectedDayStyle
                    : widget.dayTextStyle,
            width: isSelected ? 135 : widget.width,
...
class DatePickerController {
  ...
  void setDateAndAnimate(DateTime date, {duration = const Duration(milliseconds: 800), curve = Curves.easeOut}) {
    ...
    if (date.compareTo(_datePickerState!.widget.startDate) >= 0 && date.compareTo(_datePickerState!.widget.startDate.add(Duration(days: _datePickerState!.widget.daysCount))) <= 0) {
  ...
  double _calculateDateOffset(DateTime date) {
    ...
    print(offset);
    print((offset * (_datePickerState!.widget.width + 6)) + ((offset - 365) * (88 / 730)));
    return (offset * (_datePickerState!.widget.width + 6)) + ((offset - 365) * (88 / 730));
  }
}
